...
import React__default, { createContext, useContext, useState, useRef, useCallback } from 'react';
...
const Provider = ({ children, config }) => {
    ...
    const [modes, setModes] = useState(defaultConfig.modes);
    const [slots, setSlots] = useState(defaultConfig.slots);
    /**
     * Установить режим
    ...
    return jsx(LayoutContext.Provider, { value: api, children: children });
};
...
const Scrollbar = ({ children, ...props }) => {
    ...
    return (jsx(Scrollbar$1, { contentProps: contentProps, wrapperProps: wrapperProps, trackYProps: trackYProps, thumbYProps: thumbYProps, trackXProps: trackXProps, thumbXProps: thumbXProps, onScrollStart: onScrollStart, onScrollStop: onScrollStop, ...props, children: children }));
};
...
const SidebarHeader = ({ children, collapsed }) => {
    ...
    return (jsx("header", { className: classes, children: jsx("div", { className: innerClasses, children: children }) }));
};
/**
...
const SidebarBody = ({ children, collapsed }) => {
    ...
    return (jsx("div", { className: classes, children: jsx(Scrollbar, { children: jsx("div", { className: innerClasses, children: children }) }) }));
};
/**
...
const SidebarFooter = ({ children, collapsed }) => {
    ...
    return (jsx("footer", { className: classes, children: jsx("div", { className: innerClasses, children: children }) }));
};
/**
 * Сайдбар макета
...
const Sidebar = ({ header, body, footer }) => {
    ...
    return (jsxs("aside", { className: classes, children: [header && jsx(SidebarHeader, { collapsed: collapsed, children: header }), body && jsx(SidebarBody, { collapsed: collapsed, children: body }), footer && jsx(SidebarFooter, { collapsed: collapsed, children: footer })] }));
};
 ...
 */
const Page = ({ children }) => {
    return jsx("div", { className: styles$6.page, children: children });
};
...
const Body = ({ children, ...props }) => {
    return (jsx("div", { className: styles$4.body, ...props, children: children }));
};
...
const Content = ({ children }) => {
    return (jsx("main", { className: styles$3.content, children: jsx(Scrollbar, { children: jsx("div", { className: styles$3.contentInner, children: children }) }) }));
};
...
const Infobar = ({ children }) => {
    ...
    return (jsx("aside", { className: classes, children: jsx("div", { className: innerClasses, children: children }) }));
};
...
const Layout = () => {
    ...
    const header = hasHeader() ? jsx(Header, { children: slots.header }) : null;
    const sidebar = hasSidebar() ? jsx(Sidebar, { ...slots.sidebar }) : null;
    const infobar = hasInfobar() ? jsx(Infobar, { children: slots.infobar }) : null;
    const footer = hasFooter() ? jsx(Footer, { children: slots.footer }) : null;
    const content = jsx(Content, { children: slots.content });
    ...
    return (jsxs("div", { className: styles.layout, ...modeAttributes, children: [sidebar, jsxs(Page, { children: [header, jsxs(Body, { children: [content, infobar] }), footer] })] }));
};
 ...
 */
const Lucent = ({ config }) => {
    return (jsx(Provider, { config: config, children: jsx(Layout, {}) }));
};
