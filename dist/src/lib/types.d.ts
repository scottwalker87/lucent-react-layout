...
import { THEME_MODE_LIGHT, THEME_MODE_DARK, HEADER_MODE_VISIBLE, HEADER_MODE_HIDDEN, FOOTER_MODE_VISIBLE, FOOTER_MODE_HIDDEN, SIDEBAR_MODE_VISIBLE, SIDEBAR_MODE_HIDDEN, SIDEBAR_MODE_COLLAPSED, SIDEBAR_MODE_EXPANDED, INFOBAR_MODE_VISIBLE, INFOBAR_MODE_HIDDEN, INFOBAR_MODE_COLLAPSED, INFOBAR_MODE_EXPANDED } from "#lib/constants";
/**
 * Пропсы для страницы
